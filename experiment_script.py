...
def graph_percentage_vs_observed(dim, 
                                ite, 
                                tries, 
                                r, 
                                tol, 
    ...
    for m in m_values:
        ...
        for i in range(ite):
            ...
            #Calculates percentage of correcly guessed entries                                     
...
#graph_percentage_vs_observed(dim = 20, ite = 4, tries = 20, r= 5, tol = 0.05, fast_but_approximate = True)            
...
def graph_percentage_vs_size(per_obs, 
    ...
    """
        ...
        tries : int
            ...
            observations will take
        min_size : int
            The minimum size of the matrix (row or column dimention)
        max_size : int
            The maximum size of the matrix (row or column dimention)           
        r : int
            The number of singular vectors
        tol : float
            The tolerance for two values to be considered equal
